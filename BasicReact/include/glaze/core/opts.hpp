...
consteval bool has_is_padded(auto&& o)
{
    return o.internal & uint32_t(opts_internal::is_padded);
}

consteval bool has_disable_padding(auto&& o)
{
    return o.internal & uint32_t(opts_internal::disable_padding);
}

consteval bool has_write_unchecked(auto&& o)
{
