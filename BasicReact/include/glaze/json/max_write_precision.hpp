...
inline constexpr decltype(auto) write_float32_t_impl() noexcept
{
    return [](auto&& val)
    {
        return write_float32_t<std::remove_reference_t<decltype(val.*MemPtr)>> {val.*MemPtr};
    };
}
...
inline constexpr decltype(auto) write_float64_impl() noexcept
{
    return [](auto&& val)
    {
        return write_float64_t<std::remove_reference_t<decltype(val.*MemPtr)>> {val.*MemPtr};
    };
}
...
inline constexpr decltype(auto) write_float_full_impl() noexcept
{
    return [](auto&& val)
    {
        return write_float_full_t<std::remove_reference_t<decltype(val.*MemPtr)>> {val.*MemPtr};
    };
}
