...
public:
    ...
    void SetConfiguration(const MainWindowConfiguration& config)
    {
        m_config = config;
    }
    MainWindowConfiguration& GetConfiguration()
    {
        return m_config;
    }
    const MainWindowConfiguration& GetConfiguration() const
    {
        return m_config;
    }
    ...
    void EnableTheming(bool enable)
    {
        m_config.themingEnabled = enable;
    }
    bool IsThemingEnabled() const
    {
        return m_config.themingEnabled;
    }
