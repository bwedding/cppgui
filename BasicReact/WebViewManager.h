...
public:
    ...
    void SetNavigationURL(const std::wstring& url)
    {
        m_navigationURL = url;
    }
    ...
    void SetDefaultContextMenusEnabled(bool enabled)
    {
        m_defaultContextMenusEnabled = enabled;
    }
    void SetBuiltInErrorPageEnabled(bool enabled)
    {
        m_builtInErrorPageEnabled = enabled;
    }
    void SetStatusBarEnabled(bool enabled)
    {
        m_statusBarEnabled = enabled;
    }
    ...
    void SetCustom404Page(const std::wstring& html)
    {
        m_html404 = html;
    }
    ...
    void SetSimpleNavigationCallback(SimpleNavigationCallback callback)
    {
        m_simpleNavigationCallback = callback;
    }
    ...
    wil::com_ptr<ICoreWebView2> GetWebView() const
    {
        return m_webview;
    }

    NativeWindowControls* GetNativeControls() const
    {
        return m_nativeControls.get();
    }
